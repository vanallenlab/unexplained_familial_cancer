...
ax.text(1,5.25,"Prostate",fontsize=5,fontfamily="Arial")
...
ax.text(1.1,2.15,"NHL",fontsize=5,fontfamily="Arial")
ax.text(0.32,1.75,"Hematologic",fontsize=5,fontfamily="Arial")
