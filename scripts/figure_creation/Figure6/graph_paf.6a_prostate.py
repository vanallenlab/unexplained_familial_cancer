...
for i, cancer in enumerate(cancer_order):
    ...
    for _, row in df.iterrows():
        ...
        if row["color"] == "lightgreen" and width > 0.01:
        ...
        if row["color"] == "plum" and width > 0.01:
    ...
    # Outline total genetic contribution
    ax.add_patch(
        plt.Rectangle(
...
output_path = os.path.join(
    results_dir,
    "combined_attributable_fraction_prostate.pdf"
)
