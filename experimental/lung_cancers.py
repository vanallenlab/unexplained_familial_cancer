...
# Horizontal bar plot
bars = ax.barh(labels, values, color="#2CA02C", height=0.5)
...
ax.set_xlabel("Proportion of lung cancer cases\nwith ≥ 1 FDR reported with lung cancer", fontsize=5)
ax.tick_params(axis='both', labelsize=5)

ax.text(0.75, 0.15, r"$P < 10^{-5}$", ha='center', va='bottom', transform=ax.transAxes, fontsize=5)

plt.tight_layout()
plt.savefig("/Users/noah/Desktop/ufc_repository/experimental/lungfig_improved.pdf", bbox_inches='tight',pad_inches=0, dpi=300)