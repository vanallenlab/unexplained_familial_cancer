...
ax.set_yticklabels([f"{y}%" for y in yticks], fontsize=7)
...
ax.text(0.73, 97, "All Cancer Patients with srWGS & EHR",
        va='bottom', ha='left', fontsize=5)

# UFC cohort label
ax.text(5.45, 2, "UFC Cohort", ha='center', va='bottom', fontsize=5)
...
ax.text(0.9, 76, "1+ Relatives with Cancer", fontsize=5)

ax.plot([2, 2], [33, 60], color='black', lw=1)
ax.plot([2, 5], [60, 60], color='black', lw=1)
ax.text(2, 61, "2+ Relatives with Cancer", fontsize=5)

ax.plot([3, 3], [18, 45], color='black', lw=1)
ax.plot([3, 6], [45, 45], color='black', lw=1)
ax.text(3, 46, "3+ Relatives with Cancer", fontsize=5)

ax.plot([4, 4], [15, 30], color='black', lw=1)
ax.plot([4, 6], [30, 30], color='black', lw=1)
ax.text(4, 31, "No PGV in a CPG", fontsize=5)

# Bottom arrows
ax.annotate('', xy=(0.05, -0.1), xytext=(0.2, -0.1),
            xycoords='axes fraction',
            arrowprops=dict(arrowstyle='-', lw=1, color='black'))

ax.annotate('', xy=(0.8, -0.1), xytext=(0.96, -0.1),
            xycoords='axes fraction',
            arrowprops=dict(arrowstyle='<-', lw=1, color='black'))
