...
workflow ANALYSIS_1A_HWAS {
  input {
    ...
    String analysis_1a_output_dir = "gs://fc-secure-d531c052-7b41-4dea-9e1d-22e648f6e228/ANALYSIS_1_ROH/1A_HWAS/"
    String chr = "20"
  ...
  String output_name = "aou.chr" + chr + ".exome.hwas.tsv"
...
task T2_data_process{
  ...
  with open("~{output_name}", "w") as f:
      # Write header
      f.write("Haplotype_ID\tGeneName\t" + "\t".join(map(str, samples)) + "\n")
