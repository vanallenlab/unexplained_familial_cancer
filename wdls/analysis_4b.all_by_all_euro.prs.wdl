...
workflow ANALYSIS_4B_PRS {
  input {
    ...
    Array[String] cancer_types = ["basal_cell","bladder","brain","breast","colorectal","cervix","hematologic","kidney","lung","melanoma","neuroendocrine","nervous","non-hodgkin","ovary","prostate","sarcoma","squamous_cell","thyroid","uterus"]
